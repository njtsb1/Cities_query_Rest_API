...
const i18n = {
  en: {
    ...
    swap: "Swap",
    notesSummary: "Notes",
    notesText: "Distances are calculated using the Haversine formula between city coordinates. Values are approximate.",
  ...
  pt: {
    ...
    notesText: "Distâncias calculadas pela fórmula de Haversine entre coordenadas. Valores aproximados.",
  ...
  es: {
    ...
    swap: "Intercambiar",
    notesSummary: "Notas",
    notesText: "Distancias calculadas con la fórmula de Haversine entre coordenadas. Valores aproximados.",
